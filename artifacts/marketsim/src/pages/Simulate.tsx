...
const EXAMPLE_IDEAS = [
  {
    emoji: "🤖",
    label: "AI لسناب شات",
    ideaText: "منصة ذكاء اصطناعي متخصصة تولّد محتوى سناب شات وتيك توك للشركات السعودية الصغيرة — فيديوهات قصيرة، ستوريز، فلاتر، وكابشنات — كل هذا بالضغط على زر واحد. المنتج موجّه للأعمال التجارية اللي تبغى تنافس المؤثرين الكبار بميزانية محدودة.",
    price: "199 ريال/شهر",
    targetAge: "22-40 سنة",
    targetCity: "الرياض، جدة، دبي",
    problemSolved: "إنتاج المحتوى اليومي مكلف ومرهق للشركات الصغيرة التي لا تستطيع توظيف مدير محتوى",
    competitors: "ChatGPT، Canva، Capcut",
  },
  {
    emoji: "🍱",
    label: "غوست كيتشن كوري-سعودي",
    ideaText: "مطبخ سحابي (ghost kitchen) متخصص في الأكل الكوري-السعودي الفيوجن: كبسة بولغوكي، مندي رامن، حمص تيوكبوكي. التوصيل عبر جاهز وهنقرستيشن ومرسول فقط، بدون صالة. الهدف: الترند والطعم في نفس الوقت.",
    price: "55-95 ريال للوجبة",
    targetAge: "16-32 سنة",
    targetCity: "الرياض",
    problemSolved: "الجيل Z يبحث عن تجارب طعام غير تقليدية قابلة للمشاركة على سناب شات وتيك توك",
    competitors: "مطاعم كورية عادية، ghost kitchens على هنقرستيشن",
  },
  {
    emoji: "💎",
    label: "BNPL للملابس الفاخرة",
    ideaText: "تطبيق تقسيط ذكي (مثل تمارا لكن متخصص) للملابس والإكسسوارات الفاخرة — زارا، مانغو، براندات محلية راقية. ادفع الربع الآن والباقي على 3 أشهر بدون فوائد. يشتغل مع متاجر سلة وزد مباشرة.",
    price: "بدون رسوم للمستخدم — عمولة من التاجر",
    targetAge: "20-35 سنة",
    targetCity: "الرياض، جدة، الدمام",
    problemSolved: "الشباب يريد الملابس الفاخرة لكن التدفق النقدي الشهري لا يسمح بشراء قطعة بـ500+ ريال",
    competitors: "تمارا، تابي",
  },
  {
    emoji: "🏟️",
    label: "تطبيق ملاعب وتحديات",
    ideaText: "منصة لحجز ملاعب كرة قدم ورياضات أخرى بالساعة في الرياض وجدة، مع نظام تحديات بين الأصدقاء وترتيب الفِرق. يشمل نادي يوري وعشرات الملاعب المستقلة. دفع عبر Apple Pay وSTC Pay فوري.",
    price: "120-280 ريال/ساعة للملعب",
    targetAge: "15-35 سنة",
    targetCity: "الرياض، جدة",
    problemSolved: "حجز الملاعب يتم عبر واتساب وكثيراً ما يكون الملعب محجوزاً أو لا يُرد على الرسائل",
    competitors: "واتساب المجموعات، تطبيقات حجز متفرقة",
  },
  {
    emoji: "🪄",
    label: "ديكور بالواقع المعزز",
    ideaText: "تطبيق موبايل يسمح لك بتصميم غرفتك أو شقتك الجديدة في روشن أو أي مشروع سكني بالواقع المعزز (AR) — اختر الأثاث من IKEA وBedroom وSteinberg وشوف كيف يبدو في غرفتك الفعلية قبل الشراء.",
    price: "مجاني + عمولة من مبيعات الأثاث",
    targetAge: "24-45 سنة",
    targetCity: "الرياض (روشن، القدية، شمال الرياض)",
    problemSolved: "كثيرون يشترون أثاثاً يكتشفون أنه لا يناسب المساحة أو اللون بعد التركيب",
    competitors: "IKEA Place، تطبيقات داخلية بدائية",
  },
  {
    emoji: "🎙️",
    label: "بودكاست AI بالعربي",
    ideaText: "منصة تحوّل أي مقال أو بوست أو تقرير إلى حلقة بودكاست بصوت عربي احترافي خلال دقيقتين. مثالية للشركات والصحفيين والمدونين العرب. دعم كامل للهجات الخليجية والمصرية والشامية.",
    price: "149 ريال/شهر للخطة الأساسية",
    targetAge: "22-45 سنة",
    problemSolved: "إنتاج البودكاست يحتاج معدات واستوديو ووقت — 90% من المحتوى العربي لا يتحول لصوت",
    competitors: "ElevenLabs، Podcastle — لكن بدون دعم عربي احترافي",
  },
  {
    emoji: "👰",
    label: "تطبيق تخطيط الزواج",
    ideaText: "منصة شاملة لتخطيط حفلات الزواج السعودية — قوائم المدعوين، ميزانية العرس، حجز القاعات والمصورين والمطابخ، قائمة التجهيزات، وتنسيق مع الأهل كل هذا في تطبيق واحد بدل مجموعات الواتساب الفوضوية.",
    price: "99 ريال/شهر أو 299 ريال للاشتراك الكامل حتى العرس",
    targetAge: "20-35 سنة",
    targetCity: "الرياض، جدة، الدمام",
    problemSolved: "تخطيط العرس السعودي يتم عبر واتساب وإكسل وآلاف الرسائل — فوضى شبه كاملة",
    competitors: "Zola (أمريكي)، لا يوجد منافس محلي حقيقي",
  },
  {
    emoji: "☕",
    label: "اشتراك قهوة متخصصة",
    ideaText: "خدمة اشتراك شهري لمحبي القهوة المتخصصة — تختار المزرعة والتحميص والطريقة، ويوصلوا لك الكيلو في المنزل طازجاً مباشرة من المحمّص. شراكات مع أفضل محامص سعودية مثل بياك والتشكيلة ومحمصات مستقلة.",
    price: "120-220 ريال/شهر للكيلو",
    targetAge: "22-40 سنة",
    targetCity: "الرياض، جدة",
    problemSolved: "عشاق القهوة المتخصصة يعانون من عدم انتظام التوريد وصعوبة اكتشاف محامص جديدة",
    competitors: "Nespresso، متاجر القهوة التقليدية",
  },
];
...
export default function Simulate() {
  ...
  const applyExample = (ex: typeof EXAMPLE_IDEAS[0], mode?: "concept" | "existing") => {
    ...
    if ("competitors" in ex && ex.competitors) setCompetitors(ex.competitors as string);
